...
class TestCredit:
    ...
    def test_credit_create_valid(self, db_session: Session, api_manager: ApiManager, create_credit_secret_user_request: CreateUserRequest, amount: int, user_credit_account: CreateUserRequest):
        credit_request = CreateCreditRequest(accountId=user_credit_account.id, amount=amount, termMonths=12)
    ...
    def test_credit_create_invalid(self, db_session: Session, api_manager: ApiManager, create_credit_secret_user_request: CreateUserRequest, amount: int, user_credit_account: CreateUserRequest):
        credit_request = CreateCreditRequest(accountId=user_credit_account.id, amount=amount, termMonths=12)
    ...
    def test_credit_repay_success(self, db_session: Session, api_manager: ApiManager, create_credit_secret_user_request: CreateUserRequest, user_credit_account: CreateUserRequest):
        credit_request = CreateCreditRequest(accountId=user_credit_account.id, amount=5000, termMonths=12)
        credit_response = api_manager.user_steps.credit_accept(credit_request, create_credit_secret_user_request)
    ...
    def test_credit_repay_failure(self, db_session: Session, api_manager: ApiManager, create_credit_secret_user_request: CreateUserRequest, credit_amount: int, repay_amount: int, user_credit_account: CreateUserRequest):
        credit_request = CreateCreditRequest(accountId=user_credit_account.id, amount=credit_amount, termMonths=12)
        credit_response = api_manager.user_steps.credit_accept(credit_request, create_credit_secret_user_request)
    ...
    def test_credit_create_twice_failure(self, db_session: Session, api_manager: ApiManager, create_credit_secret_user_request: CreateUserRequest, user_credit_account: CreateUserRequest):
        credit_request = CreateCreditRequest(accountId=user_credit_account.id, amount=5000, termMonths=12)
        api_manager.user_steps.credit_accept(credit_request, create_credit_secret_user_request)
        credit_request_2 = CreateCreditRequest(accountId=user_credit_account.id, amount=5000, termMonths=12)
    ...
    def test_credit_create_on_second_credit_id_failure(self, db_session: Session, api_manager: ApiManager, create_credit_secret_user_request: CreateUserRequest, user_with_two_credit_accounts: CreateUserRequest):
        first, second = user_with_two_credit_accounts
        credit_request = CreateCreditRequest(accountId=first.id, amount=5000, termMonths=12)
        api_manager.user_steps.credit_accept(credit_request, create_credit_secret_user_request)

        credit_request_2 = CreateCreditRequest(accountId=second.id, amount=5000, termMonths=12)
        response_failure = api_manager.user_steps.credit_failure(credit_request_2, create_credit_secret_user_request)
