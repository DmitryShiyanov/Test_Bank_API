...
class TestBankAccountDeposit:
    ...
    def test_account_deposit_with_valid_amount(self, db_session: Session, api_manager: ApiManager, create_user_request: CreateUserRequest, amount: int, user_account_and_request_fabric):
        account_deposit = user_account_and_request_fabric(amount)
    ...
    def test_account_deposit_with_invalid_amount(self, db_session: Session, api_manager: ApiManager, create_user_request: CreateUserRequest, amount: int, user_account, user_account_and_request_fabric):
