...
class TestUserCreate:
    ...
    def test_user_create_success(self, api_manager: ApiManager, create_user_request: CreateUserRequest,
                                 db_session: Session):
    ...
    def test_create_user_invalid_credentials(self, api_manager: ApiManager, db_session: Session, username: str,
                                             password: str):
