...
class TestBankAccountTransactions:
    def test_account_transactions(self, db_session: Session, api_manager: ApiManager, create_user_request: CreateUserRequest, create_and_deposit_account: CreateUserRequest, user_account: CreateUserRequest):
        deposit_response, transaction_request = create_and_deposit_account
